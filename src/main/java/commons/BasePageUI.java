...
public class BasePageUI {
	...
	public static final String ADMIN_NAV_BAR_SUB_MENU_LEVEL_1 = "xpath=//li[@class='parent last level1']";
	...
	public static final String ADMIN_TABLE_HEADER_BY_NAME = "xpath=//span[text() = '%']//parent::a";
